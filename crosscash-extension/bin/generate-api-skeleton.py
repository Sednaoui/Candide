...
# `python crosscash-extension/bin/generate-api-skeleton.py`
#
...
API_ROOT = 'crosscash-extension/src/background/api'
SUPPORTED_APIS = [
    # 'web3_clientVersion',
    # 'web3_sha3',
    # 'net_version',
...
export default function {api}(_params: Params): void {{
    log.error('Crosscash: "{api}" method is not implemented');
}}
"""

INDEX_FILE_TEMPLATE = \
"""// ! DO NOT EDIT THIS FILE BY HAND !
// File is generated from running crosscash-extension/bin/generate-api-skeleton.py
...
{cases}
        default:
            log.error(`Crosscash: ${{msg.data.method}} method is not recognized.`);
            break;
    }}
}}
"""
